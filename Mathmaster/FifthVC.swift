...
class FifthVC: UIViewController {
    ...
    func generateRandomNumbers(){
        ...
        secondNumber = Int(arc4random_uniform(20)+1)
        whichButtonCorrect = Int(arc4random_uniform(4))
        sumAnswer = firstNumber % secondNumber
        
        otherAnswerWrong1 = sumAnswer + Int(arc4random_uniform(5)+1)
        while(otherAnswerWrong1 == sumAnswer){
            otherAnswerWrong1 = sumAnswer + Int(arc4random_uniform(5)+1)
        }
        otherAnswerWrong2 = sumAnswer + Int(arc4random_uniform(10)+1)
        while(otherAnswerWrong2 == sumAnswer || otherAnswerWrong2 == otherAnswerWrong1){
            otherAnswerWrong2 = sumAnswer + Int(arc4random_uniform(5)+1)
        }
        otherAnswerWrong3 = sumAnswer + Int(arc4random_uniform(3)+1)
        while(otherAnswerWrong3 == sumAnswer || otherAnswerWrong3 == otherAnswerWrong1 || otherAnswerWrong3 == otherAnswerWrong2){
            otherAnswerWrong3 = sumAnswer + Int(arc4random_uniform(5)+1)
        }
